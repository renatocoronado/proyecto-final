...
df_customer_dim.to_sql('customer_dimension', mysql_driver, index=False, if_exists='append')

df_product_dim.to_sql('product_dimension', mysql_driver, index=False, if_exists='append')

df_location_dim.to_sql('location_dimension', mysql_driver, index=False, if_exists='append')
